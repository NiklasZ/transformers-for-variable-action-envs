...
agent = OptimisedWeightedAgent(mapsize, envs, device, args.transformer_layers, args.feed_forward_neurons,
...
for update in range(starting_update, num_updates + 1):
    ...
    for step in tqdm.tqdm(range(0, args.num_steps)):
        ...
        with torch.no_grad():
            action, logproba, _, invalid_action_masks[step], values[step] = agent.get_action_and_value(
                obs[step],
                entity_masks[step],
                entity_counts[step],
                unit_positions[step],
    ...
    for i_epoch_pi in tqdm.tqdm(range(args.update_epochs)):
        ...
        for start in range(0, args.batch_size, args.minibatch_size):
            ...
            _, newlogproba, entropy, _, new_values = agent.get_action_and_value(
                ...
                b_neutral_unit_masks[minibatch_ind],
